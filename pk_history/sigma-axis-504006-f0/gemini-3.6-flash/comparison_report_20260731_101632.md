...
**Session Timestamp**: `20260731_101632`
**Target Project**: `sigma-axis-504006-f0`
**Target Model Tested**: `gemini-3.6-flash`
**Traffic Stress Profile (压测用例)**: `标准巡检 (3.6 Flash Standard)`
...
| **平均端到端延迟 (Avg Latency)** | **2.458 秒** | **0.000 秒** | 暂无成功数据 |
| **最小/最大延迟 (Min/Max)** | 2.21s / 2.87s | 0.00s / 0.00s | - |
