...
| **平均端到端延迟 (Avg Latency)** | **30.929 秒** | **24.396 秒** | 🔵 Gemini API (更低延迟) |
| **最小/最大延迟 (Min/Max)** | 27.87s / 36.68s | 21.13s / 28.96s | - |
...
| :---: | :---: | :--- | :--- | :--- |
| 1 | 🟢 OK | 36.683s | $0.09680 | - |
| 2 | 🟢 OK | 28.234s | $0.09680 | - |
| 3 | 🟢 OK | 27.869s | $0.09680 | - |

### Gemini API (gemini_api)
| Trial # | Status | Latency | Cost | Error details (if any) |
| :---: | :---: | :--- | :--- | :--- |
| 1 | 🔵 OK | 28.956s | $0.15100 | - |
| 2 | 🔵 OK | 23.105s | $0.15100 | - |
| 3 | 🔵 OK | 21.126s | $0.15100 | - |
