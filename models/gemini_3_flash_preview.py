...
PRICING_GCP["gemini-3-flash-preview"] = {"in": 0.075 / 1000000.0, "out": 0.30 / 1000000.0}
PRICING_API["gemini-3-flash-preview"] = {"in": 0.075 / 1000000.0, "out": 0.30 / 1000000.0}

class Gemini3FlashPreviewTester(BaseModelTester):
    """
    Plugin tester for gemini-3-flash-preview.
    """
    ...
    def get_traffic_profiles(cls):
        return {
            "standard": {"name": "标准巡检 (3 Flash Preview Standard)", "trials": 5, "delay": 1.5, "desc": "常规同频延迟与通信比对测试"},
            "concurrency_stress": {"name": "高频并发压力 (3 Flash Preview Stress)", "trials": 25, "delay": 0.3, "desc": "模拟高负载高突发情况下的并发测试"}
        }

    def get_default_prompt(self):
        return "Explain the main capabilities of Gemini 3 Flash Preview in exactly 40 words."
...
export_class = Gemini3FlashPreviewTester
